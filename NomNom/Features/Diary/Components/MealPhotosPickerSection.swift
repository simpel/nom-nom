...
/// Multi-photo picker and hero card deck presentation with slot-opening drag-to-reorder for meals.
struct MealPhotosPickerSection: View {
    ...
    var body: some View {
        ...
        .sheet(item: Binding(
            get: { previewIndex.map { MealPhotoPreviewItem(index: $0) } },
...
private struct MealPhotoPreviewItem: Identifiable {
    let index: Int
    var id: Int { index }
}
