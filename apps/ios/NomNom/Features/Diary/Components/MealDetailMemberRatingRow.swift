...
struct MealDetailMemberRatingRow: View {
    ...
    init(
        ...
        self.hasExplanation = hasExplanation
        self.onTapRate = onTapRate
        self.onAskToRate = onAskToRate
        self.onTapExplain = onTapExplain
    }
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            if reaction != nil, hasExplanation, let onTapExplain {
                Button(action: onTapExplain) {
